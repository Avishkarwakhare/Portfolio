      ...
      <div className="flex flex-col lg:flex-row gap-12 items-center">
        ...
        >
          ...
          <p className="text-lg md:text-[1.1rem] text-muted-foreground leading-[1.8] font-medium max-w-[42rem]">
            I'm a passionate software developer with experience in Python,
            Java, and C++, and expertise in modern technologies like React,
            Node.js, and the MERN stack. I enjoy building scalable, user-friendly 
            applications and continuously improving my problem-solving skills.
            I'm a quick learner who loves turning ideas into real-world 
